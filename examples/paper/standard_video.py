...
from examples.paper.conf import NFRAMES_STANDARD, SIMSHAPE, BACKGROUND, DELTA, \
    INTENSITY, PERIOD, SIGMA, SHAPE,DUST1_PATH, BIT_DEPTH, VMAX, NOISE_MODEL, SATURATION, READOUT_NOISE
...
video = simple_brownian_video(range(NFRAMES_STANDARD), shape = SIMSHAPE,background = BACKGROUND, dt = PERIOD/2.,
