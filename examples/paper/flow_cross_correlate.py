...
import examples.paper.flow_video.dual_video as dual_video
...
if __name__ == "__main__":
    ...
    data = ccorr(fft1,fft2, t1 = t1,t2 = t2, n = NFRAMES_DUAL, complex = True)
    ...
    for norm in (5,6,7):
        ...
        np.save(p.join(DATA_PATH, "flow_corr_dual_linear_norm{}.npy".format(norm)),data_lin)
        ...
        #np.save(p.join(DATA_PATH, "flow_corr_dual_t.npy"),x)
        #np.save(p.join(DATA_PATH, "flow_corr_dual_data_norm{}.npy".format(norm)),y)
