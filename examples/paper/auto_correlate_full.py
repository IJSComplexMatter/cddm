...
import examples.paper.full_video as video_simulator
import importlib
importlib.reload(video_simulator) #recreates iterator

from examples.paper.conf import KIMAX, KJMAX, SHAPE, NFRAMES_FULL, DATA_PATH, PERIOD
...
if __name__ == "__main__":
    ...
    np.save(p.join(DATA_PATH, "auto_correlate_full_t.npy"),x)
    np.save(p.join(DATA_PATH, "auto_correlate_full_data.npy"),y)
