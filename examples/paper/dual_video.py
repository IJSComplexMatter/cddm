...
from examples.paper.conf import NFRAMES_DUAL, N_PARAMETER, SIMSHAPE, BACKGROUND, DELTA, VMAX,\
    INTENSITY, SIGMA, SHAPE, DUST1_PATH, DUST2_PATH, SATURATION, BIT_DEPTH, NOISE_MODEL, READOUT_NOISE, NUM_PARTICLES
...
video = simple_brownian_video(t1,t2, shape = SIMSHAPE,background = BACKGROUND,num_particles = NUM_PARTICLES,
